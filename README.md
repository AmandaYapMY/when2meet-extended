...
![Default When2Meet view](images/normal.png)

### One person selected

Selecting one participant highlights the times when that person is available.

![One person selected](images/one-person.png)
...
![Two people selected](images/two-people.png)
...
![Three people selected](images/three-people.png)
